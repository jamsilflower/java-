...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        * Compiter(컴퓨터에게 자바 언어를 이해 하게 만드는 것) 와 약속한 키워드 이다.
        * 예를들어 앞에서 사용한 int라는 자료형은 정수를 4byte 만큼 잃어서
        * 하나의 값으로 취급하겠다는 약속이다.
        ...
        * 그 중 기본자료형 8가지 부터 살펴보자.
        ...
        /*필기. 이상 8가지를 기본자료형(Primary) 이라고한다. */

        /*목차. 1-1-4. 문자열을 취급하는 자료형  */
        String str; // 4byte 주소는 엄밀히 따지면 4byte
        ...
        snum = 2;
        inum = 4;
        lnum = 8L; // 소문자 l을 써도 되지만, 숫자 1과 했갈리니 대문자로 씀.

        /*목차. 2-2. 실수를 취급하는 자료형에 값 대입해보기 */
        fnum = 4.0f; // 대문자 F를 사용해도 되지만 소문자로 쓴다.
        dnum = 8.0;
